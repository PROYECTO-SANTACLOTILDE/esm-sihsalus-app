...
export const configSchema = {
  ...
  // 16. CRED FORMS BY AGE GROUP CONFIGURATION
  CREDFormsByAgeGroup: {
    _type: Type.Array,
    ...
    _default: [
      {
        ...
        minMonths: 0,
        maxMonths: 0.93,
        forms: ['nutritionEvaluation', 'dangerSigns', 'newbornScreening', 'breastfeedingCounseling'],
      },
      {
        label: '2 MESES',
        minMonths: 1,
        maxMonths: 2.5,
        forms: ['nutritionEvaluation', 'dangerSigns', 'vifScreening', 'growthDevelopment', 'immunizationSchedule'],
      },
      {
        label: '4 MESES',
        minMonths: 2.5,
