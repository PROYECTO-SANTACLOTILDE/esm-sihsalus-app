...
const PrenatalCareChart: React.FC<ProgramsDetailedSummaryProps> = ({ patientUuid }) => {
 ...
 const allPossibleRows = useMemo(() => [
  ...
  { id: "proteinuriaGestacional", rowHeader: t("proteinuriaGestacional", "Proteinuria gestacional"), prefix: "proteinuria gestacional" },
  ...
  { id: "indicacionFierro", rowHeader: t("indicacionFierro", "Indicación Fierro/Acido Fólico"), prefix: "Indicación Fierro/Acido Fólico" },
  { id: "temperatura", rowHeader: t("temperatura", "Temperatura (C°)"), prefix: "Temperatura (C°)" },
  { id: "orientacion", rowHeader: t("orientacion", "Orientación y consejería"), prefix: "Orientación y consejería" },
  ...
  { id: "indicacionAcidoFolico", rowHeader: t("indicacionAcidoFolico", "Indicación Acido Fólico"), prefix: "Indicación Acido Fólico" },
  { id: "visitaDomiciliaria", rowHeader: t("visitaDomiciliaria", "Visita domiciliaria"), prefix: "Visita domiciliaria" },
  { id: "edadGestacionalEcografia", rowHeader: t("edadGestacionalEcografia", "Edad gestacional en semanas según ecografía"), prefix: "Edad gestacional en semanas según ecografía" },
  ...
  { id: "reflejoOsteotendinoso", rowHeader: t("reflejoOsteotendinoso", "Reflejo osteotendinoso"), prefix: "Reflejo osteotendinoso" },
], [t]);
