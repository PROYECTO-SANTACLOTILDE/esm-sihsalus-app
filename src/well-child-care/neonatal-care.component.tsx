...
import BiometricsBase from './components/newborn-monitoring/biometrics/biometrics-base.component';
        ...
        <Tabs>
          ...
          <TabPanels>
            <TabPanel>
              ...
              <BiometricsBase patientUuid={patientUuid} pageSize={10} urlLabel={'urlLabel'} pageUrl={'pageUrl'} />
            </TabPanel>
